...
public class FavoriteSourcesController {
    ...
    @Operation(
            ...
            description = "Retrieve a favorite news source by its unique ID.")
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Add a new favorite news source.")
    @ApiResponses(value = {
    ...
    @Operation(
            summary = "Get Favorite Sources with Parameters",
            description = "Retrieve favorite news sources based on provided query parameters. " +
                    "You can filter by 'newsApiKey' to get all favorite sources for that key, " +
                    "or by both 'newsApiKey' and 'sourceId' to get a specific favorite source.")
    @ApiResponses(value = {
